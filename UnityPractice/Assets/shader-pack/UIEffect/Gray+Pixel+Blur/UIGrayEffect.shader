Shader "UIEffect/Gray"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				//置灰公式
				//value=color.r x 0.299 +color.g x 0.587 + color.b * 0.114
				...
				//color = fixed4(color.rgb*fixed3(0.537, 0.537, 0.537),1);
				fixed cc = color.r*0.299+color.g*0.587+color.b*0.114;
				color = fixed4(cc,cc,cc,1);
				return color;
			}
		ENDCG
		}
