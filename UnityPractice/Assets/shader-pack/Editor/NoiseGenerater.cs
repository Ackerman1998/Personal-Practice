...
public class NoiseGenerater : EditorWindow
{
    ...
    [MenuItem("ToolsPro/Free Birdの噪音生成器")]
    #region 界面初始化
    static void Init()
    {
    ...
    private void OnGUI()
    {
        ...
        offsetX = EditorGUILayout.Slider(offsetX, -100, 100);//噪音位移设置
        GUILayout.Label("噪音位移Y = ");
        offsetY = EditorGUILayout.Slider(offsetY, -100, 100);//噪音位移设置
        GUILayout.EndHorizontal();
    ...
    Color CalculateColor(int x, int y)
    {
        ...
        //Debug.LogError("Generate Perlin Noise,xCoord = " + xCoord + " , yCoord = " + yCoord + " , sample = " + sample);
